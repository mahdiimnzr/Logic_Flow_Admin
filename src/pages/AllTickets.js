...
const AllTickets = () => {
  ...
  const fetchTicketsData = () => {
    if (activeTab === "1")
      return getAllTicketsAdmin(0, 1000, debouncedSearchValue);
    if (activeTab === "2")
      return getMyTicketsSupporter(0, 1000, debouncedSearchValue);
    if (activeTab === "3")
      return getNotAcceptedTicketsSupporter(0, 1000, debouncedSearchValue);
  };
  ...
  const handleAcceptTicket = async (ticketId) => {
    ...
    if (isSuccess) {
      toast.success(result.message || t("SuccessInTickets"));
      refetch();
    } else {
      toast.error(t("ErrorInTickets"));
    }
  };
  ...
  const customStyles = {
    ...
    rows: {
      style: {
        ...
        borderBottomColor: skin === "dark" ? "#3b4253" : "#ebe9f1",
        "&:hover": { backgroundColor: skin === "dark" ? "#343d55" : "#f8f8f8" },
      },
    },
    pagination: {
      style: {
  ...
  return (
    <Fragment>
      <BreadCrumbs
        title={t("TicketsList")}
        data={[{ title: t("TicketsManagement") }, { title: t("TicketsList") }]}
      />
          ...
          <Card>
            ...
            <div className="react-dataTable position-relative">
              ...
              <DataTable
                ...
                columns={getTicketColumns(handleAcceptTicket, t)}
