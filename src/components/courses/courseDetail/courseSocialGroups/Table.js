...
import SidebarNewSocialGroup from "./SideBar";
        ...
        >
          <div className="d-flex align-items-center mb-sm-0 mb-1 me-1">
            ...
            <Input
              ...
              type="text"
              value={searchTerm}
              placeholder={t("SearchSocialGroups")}
...
const SocialGroupList = ({ data, isFetching }) => {
  const { t } = useTranslation();
  ...
  return (
    <Fragment>
      ...
      <SidebarNewSocialGroup open={sidebarOpen} toggleSidebar={toggleSidebar} />
    </Fragment>
  );
};
