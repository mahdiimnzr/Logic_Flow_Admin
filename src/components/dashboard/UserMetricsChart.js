...
const UserMetricsChart = ({ dataSeries = [0, 0], skin }) => {
  ...
  const options = {
    ...
    labels: [t("DashboardsActiveUsers"), t("DashboardsCompleteProfile")],
  };

  return (
    <Card className="h-100">
      <CardHeader>
        <CardTitle tag="h4"> {t("DashboardsUserIndex")} </CardTitle>
      </CardHeader>
      <CardBody className="d-flex flex-column align-items-center justify-content-center">
        ...
        <div className="d-flex justify-content-center w-100 mt-2">
          <div className="d-flex align-items-center mx-1">
            ...
            ></span>
            <span
              className="fs-6 me-25"
              style={{ color: "#7367f0", fontWeight: "bold" }}
            >
              {t("DashboardsActiveUsers")}
            </span>
          </div>
          <div className="d-flex align-items-center mx-1">
            <span
